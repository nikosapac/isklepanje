...
public class Funkcije {
	...
	public Funkcije(WebDriver driver) {
		this.driver = driver;
	}
	...
	public String JwtToken(String email, String password) throws InterruptedException  {
		driver.get("https://adb2ctriglavqa.b2clogin.com/adb2ctriglavqa.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1A_ITRIGLAV3_CUSTOMEMAIL_SIGNUP_SIGNIN_DRAJVMIGRATION&client_id=afa45fd4-b41d-40eb-af10-51123dbba18d&nonce=defaultNonce&redirect_uri=https%3A%2F%2Fjwt.ms%2F&scope=openid&response_type=id_token&prompt=login");
	...
	public String JwtTokenDev(String email, String password) throws InterruptedException  {
		driver.get("https://adb2ctriglavdev.b2clogin.com/adb2ctriglavdev.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1A_ITRIGLAV3_CUSTOMEMAIL_SIGNUP_SIGNIN_SOCIAL&client_id=f06ae067-c520-408c-ab4d-66cf3f32dd23&nonce=defaultNonce&redirect_uri=https%3A%2F%2Fjwt.ms%2F&scope=openid&response_type=id_token&prompt=login");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
		Thread.sleep(1500);
	...
	public void ScrollInKlik2(String pot) throws InterruptedException {
		/*Actions action = new Actions(driver);
		action.moveToElement(driver.findElement(By.xpath(pot))).build().perform();
		//((JavascriptExecutor) driver).executeScript("window.scrollBy(0,100)");
		Thread.sleep(500);
	...
	public void ScrollInKlik3(By locator) throws InterruptedException {
		/*Actions action = new Actions(driver);
	...
	public void ScrollInKlik4(By locator) throws InterruptedException {
		Actions action = new Actions(driver);
		action.moveToElement(driver.findElement(locator)).build().perform();
	//	((JavascriptExecutor) driver).executeScript("window.scrollBy(0,-100)");
		Thread.sleep(500);
