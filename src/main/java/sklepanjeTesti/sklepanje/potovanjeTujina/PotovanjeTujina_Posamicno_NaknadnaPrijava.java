...
// HAPPPY FLOW - Test prijavljene osebe, ki sklene posamicno zavarovanje in se NAKNADNO PRIJAVI ( trajanje 5 dni, + "se boste v tujini ukvarjali z različnimi športi... DA", Paket C )

public class PotovanjeTujina_Posamicno_NaknadnaPrijava {
	private WebDriver driver;

	public PotovanjeTujina_Posamicno_NaknadnaPrijava(WebDriver driver) {
		this.driver = driver;
	}

	public void PotovanjeTujinaPosamicnoNaknadnaPrijavaTest() throws InterruptedException {
