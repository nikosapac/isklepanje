...
import sklepanjeTesti.zdruzeniDeliAljosa.UnhappyPersonalInfoLogOUT;

public class OdstranjevanjePodatkov {
	private WebDriver driver;
	public OdstranjevanjePodatkov (WebDriver driver) {
		this.driver = driver;
	}
	...
	public void maliPaket2Otroci() throws InterruptedException {
		...
		UnhappyPersonalInfoLogOUT upo = new UnhappyPersonalInfoLogOUT(driver);
		...
		for(int i = 0; i <= 8; i++) {
			...
			if(i != 2) {
				driver.findElement(By.id("surname")).sendKeys("ing");
			}
			driver.findElement(By.id("birthday")).clear();
			if(i != 3) {
				driver.findElement(By.id("birthday")).sendKeys("01.10.2001");
			}
			driver.findElement(By.id("taxnum")).clear();
			if(i != 4) {
				driver.findElement(By.id("taxnum")).sendKeys("82870861");
			}
			if(i == 5) {
			...
			if(i == 6) {
				...
				f.ScrollInKlik2(By.id("taxnum"));
				driver.findElement(By.id("childMemberAddModal")).sendKeys(Keys.PAGE_DOWN, Keys.PAGE_DOWN);
			}
			if(i == 7) {
				f.ScrollInKlik2(By.id("addressSearch.street"));
				driver.findElement(By.id("addressSearch.street")).sendKeys(Keys.ARROW_DOWN);
				driver.findElement(By.id("addressSearch.street")).sendKeys(Keys.ARROW_DOWN, Keys.RETURN);
				f.ScrollInKlik2(By.id("taxnum"));
			}
			if(i >= 0 && i <= 8) {
				driver.findElement(By.id("childMemberAddModal")).sendKeys(Keys.PAGE_DOWN, Keys.PAGE_DOWN);
			...
			switch(i) {
			case 1:
				driver.findElement(By.id("name.errors"));
				break;
			case 2:
				driver.findElement(By.id("surname.errors"));
				break;
			case 3:
				driver.findElement(By.id("birthday.errors"));
				break;
			case 4:
				driver.findElement(By.id("taxnum.errors"));
				break;
			case 5:
				driver.findElement(By.id("addressSearch.result.inputComplete.errors"));
				break;
			case 6:
				driver.findElement(By.id("addressSearch.result.inputComplete.errors"));
				break;
		...
		/////////////////////
		f.ScrollInKlik2(By.className("submitButton"));
		driver.findElement(By.id("numParties.errors"));
		f.ScrollInKlik2(By.xpath("(//*[@class = 'radio--secondary__button'])[2]"));
		f.ScrollInKlik2(By.className("submitButton"));
		driver.findElement(By.id("policyHolderUI.childRegisteredSportsman.errors"));
		f.ScrollInKlik2(By.xpath("(//*[@class = 'radio--secondary__button'])[1]"));
