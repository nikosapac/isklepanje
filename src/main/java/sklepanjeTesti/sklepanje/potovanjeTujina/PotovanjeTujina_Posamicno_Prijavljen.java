...
// HAPPPY FLOW - Test neprijavljene osebe, ki sklene posamicno zavarovanje ( trajanje 2 dni, Paket B )

public class PotovanjeTujina_Posamicno_Prijavljen {
	private WebDriver driver;

	public PotovanjeTujina_Posamicno_Prijavljen(WebDriver driver) {
		this.driver = driver;
	}

	public void PotovanjeTujinaPosamicnoPrijavljenTest() throws InterruptedException {
