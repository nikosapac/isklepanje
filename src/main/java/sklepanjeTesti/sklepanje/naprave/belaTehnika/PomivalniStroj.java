package sklepanjeTesti.sklepanje.naprave.belaTehnika;
...
public class PomivalniStroj {
	
	WebDriver driver;
	
	public PomivalniStroj(WebDriver driver) {
		this.driver = driver;
	}
		...
		public void NapraveTest() throws Exception {
			...
			driver.findElement(By.xpath("(//*[@class='db-icon-big'])[2]")).click();
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
			funk.ScrollInKlik2(By.className("nextStep"));
			
			// VRSTA NAPRAVE
			
			driver.findElement(By.xpath("(//*[@class='db-icon-big'])[5]")).click();
