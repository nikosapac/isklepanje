...
public class TestRunner {
    ...
    private static final Logger logger2 = LoggerFactory.getLogger(TestRunner.class);
	...
	//	logger.assignCategory("Bančne kartice");
	    ...
	    NezgodaQ222 nez = new NezgodaQ222(driver);
	...
	public void BancneKartice() throws Exception {
	    ...
	    BancneKartice222 bk = new BancneKartice222(driver);
	...
	//	logger.assignCategory("Mikromobilnost");
	    ...
	    Mikromobilnost222 mikro = new Mikromobilnost222(driver);
	...
	//	logger.assignCategory("Avtomobili");
	    ...
	    Avtomobili222 avto = new Avtomobili222(driver);
	...
	//	WebDriver driver = getDriver();
	    ...
	    MaleZivali222 mz = new MaleZivali222(driver);
	    mz.MaleZivaliQTest();
	...
	//	WebDriver driver = getDriver();
	    ...
	    MladiVoznik222 mv = new MladiVoznik222(driver);
	    mv.MladiVoznikTest();
	...
	//	logger.assignCategory("Motor");
	    ...
	    Motor222 mot = new Motor222(driver);
	    mot.MotorTest();
	...
	//	logger.assignCategory("Odpoved potovanj");
	    ...
	    OdpovedPotovanj222 op = new OdpovedPotovanj222(driver);
	...
	//	WebDriver driver = getDriver();
	    ...
	    OsebnaZascita222 oz = new OsebnaZascita222(driver);
	...
	//	logger.assignCategory("Potovanje");
	    ...
	    Potovanje222 pot = new Potovanje222(driver);
	    pot.PotovanjeQTest();
	...
	//	logger.assignCategory("Naprave");
	    ...
	    MobilniTelefoni222 mob = new MobilniTelefoni222(driver);
	    mob.NapraveTest();
