...
public class NajboljZajeten0NoLogin {
	private WebDriver driver;
	public NajboljZajeten0NoLogin (WebDriver driver) {
		this.driver = driver;
	}
	public void maleZivaliPrviTest() throws InterruptedException {
		...
		UnhappyPersonalInfoLogOUT upi = new UnhappyPersonalInfoLogOUT(driver);
		...
		wait.until(ExpectedConditions.urlToBe("https://skleni-qa.triglav.si/isklepanje/zivali/zavarovanje_psov_in_mack"));
			...
			//checking if only one button is showing when logged in
