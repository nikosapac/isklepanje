...
import sklepanjeTesti.zdruzeniDeliAljosa.PersonalInfoPrijavNujne;

public class PrijavZivali0MaliPaket0VsaDodatna2 {
	private WebDriver driver;
	public PrijavZivali0MaliPaket0VsaDodatna2 (WebDriver driver) {
		this.driver = driver;
	}
	public void maleZivaliPrviTest() throws InterruptedException {
		...
		PersonalInfoPrijavNujne pin = new PersonalInfoPrijavNujne(driver);
		...
		p.ItriglavPrijavaSklepanje2(mail, pass);
		wait.until(ExpectedConditions.elementToBeClickable(By.className("submitButton")));
