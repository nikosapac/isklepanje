...
// HAPPPY FLOW - Test neprijavljene osebe, ki sklene druzinsko zavarovanje in se NAKNADNO PRIJAVI ( trajanje 1 leto + "90 ali več dni", Paket A )

public class PotovanjeTujina_Druzinsko_NaknadnaPrijava {
	private WebDriver driver;

	public PotovanjeTujina_Druzinsko_NaknadnaPrijava(WebDriver driver) {
		this.driver = driver;
	}

	public void PotovanjeTujinaDruzinskoNadoknadnaPrijavaTest() throws InterruptedException {
		...
		if (ele.isDisplayed()) {
			System.out.println("Sklenitev je bila uspesna - TEST: PotovanjeTujina_Druzinsko_NaknadnaPrijava");
		} else {
			throw new RuntimeException("Sklenitev NI bila uspesna - TEST: PotovanjeTujina_Druzinsko_NaknadnaPrijava");
		}
	}
