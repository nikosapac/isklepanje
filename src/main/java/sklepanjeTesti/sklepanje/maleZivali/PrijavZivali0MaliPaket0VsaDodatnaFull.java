...
public class PrijavZivali0MaliPaket0VsaDodatnaFull {
	private WebDriver driver;
	public PrijavZivali0MaliPaket0VsaDodatnaFull (WebDriver driver) {
		this.driver = driver;
	}
	public void maleZivaliPrviTest() throws InterruptedException {
		...
		ChangingPersonalInfoPrijav chin = new ChangingPersonalInfoPrijav(driver);
