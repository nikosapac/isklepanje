...
public class Projektor {
	...
	public Projektor(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void NapraveTest() throws Exception {
		...
		driver.findElement(By.xpath("(//*[@class='db-icon-big'])[6]")).click();
...
TIER 10 -> Registriran uporabnik brez dviga nivoja (email in geslo)
TIER 20 -> Uporabnik, ki se je prijavil z sipassom  
TIER 30 -> Uporabnik ki je dvignil nivo 

- ali sta eva.kolbl@triglav.si in kolbleva@gmail.com ista oseba:

Da, ker je dodan način prijave z obema mailoma

- kako dobim 5% za digitalnost na triglav kompletu. 

Registracija v itriglav,
Soglasje za elektronsko obveščanje,
Soglasje za obdelavo osebnih podatkov

in pa zanima me, katero aplikacijo oziroma storitev uporabljamo za spremljanje logov apliakcij na aksu?
